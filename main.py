...
def generate_marketing_api(request: Request, data: dict):
    ...
    if content:
        ...
        return {"status": "error", "message": "La IA no respondió. Revisa los logs de Render o si la API Key de Gemini es correcta."}
