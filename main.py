...
# ==========================================
# 📧 CONFIGURACIÓN DE CORREO (Para recuperar claves)
# ==========================================
SMTP_SERVER = "smtp.gmail.com"
SMTP_PORT = 587
SMTP_EMAIL = "mymundodigital0@gmail.com"
SMTP_PASSWORD = "TU_CONTRASEÑA_DE_APLICACION_AQUI" # ¡PON AQUÍ TU CONTRASEÑA DE 16 LETRAS DE GOOGLE!
...
# ✅ CLAVES DE PRUEBA PARA PROBAR LOS 3 PLANES (Incluyen email para probar recuperación)
licenses_db = {
    "BLENIN-TEST-ORO": {"hwid": None, "expires": TEST_EXPIRY_DATE, "active": True, "plan": "ORO", "email": "test-oro@blenin77.com"},
    "BLENIN-TEST-PLATA": {"hwid": None, "expires": TEST_EXPIRY_DATE, "active": True, "plan": "PLATA", "email": "test-plata@blenin77.com"},
    "BLENIN-TEST-BRONCE": {"hwid": None, "expires": TEST_EXPIRY_DATE, "active": True, "plan": "BRONCE", "email": "test-bronce@blenin77.com"}
}
...
def recover_by_email(req: RecoveryRequest):
    """Busca la licencia por correo y la envía por email automáticamente"""
    email = req.email.lower()
    for key, info in licenses_db.items():
        if info.get("email", "").lower() == email and info["active"]:
            subject = "🔑 Recuperación de tu Licencia BLENIN77"
            body = f"Hola!\n\nSolicitaste recuperar tu clave de suscripción a BLENIN77.\n\nTu clave es: {key}\nPlan: {info['plan']}\n\nPuedes descargar el sistema desde nuestro enlace oficial e ingresar esta clave para continuar operando."
