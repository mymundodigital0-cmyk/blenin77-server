...
<body class="text-slate-300 bg-grid">
    ...
    <!-- Hero Section -->
    <header class="relative overflow-hidden py-24 md:py-32">
        <div class="absolute inset-0 bg-gradient-to-b from-cyan-900/10 to-slate-950"></div>
        <div class="container mx-auto px-6 text-center relative z-10">
            ...
            <h2 class="text-lg md:text-xl text-slate-400 font-light mb-6 tracking-wider uppercase">{c.get('hero_subtitle', '')}</h2>
