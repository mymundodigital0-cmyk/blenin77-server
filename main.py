...
<body class="text-slate-300 bg-grid">
    ...
    <!-- Hero Section con la Imagen del Bot de Fondo -->
    <header class="relative overflow-hidden py-32 md:py-40" style="background-image: linear-gradient(to bottom, rgba(2, 6, 23, 0.8), rgba(2, 6, 23, 0.95)), url('https://raw.githubusercontent.com/mymundodigital0-cmyk/blenin77-server/main/bienvenida_blenin.png'); background-size: cover; background-position: center; background-attachment: fixed;">
        <div class="container mx-auto px-6 text-center relative z-10">
            ...
            <h2 class="text-lg md:text-xl text-slate-300 font-light mb-6 tracking-wider uppercase">{HERO_SUBTITLE}</h2>
    ...
    <div class="py-16 bg-slate-950 border-t border-slate-800">
