...
# ==========================================
# 🧠 INTELIGENCIA ARTIFICIAL (GROQ API - LLAMA 3 ULTRA RÁPIDO)
# ==========================================
    ...
    <div class="flex-1 container mx-auto p-6 md:p-10 max-w-4xl">
        ...
        <div id="content-ai" class="hidden space-y-6">
            <div class="bg-slate-800 p-6 rounded-xl border border-cyan-700 shadow-lg">
                ...
                <p class="text-sm text-slate-400 mb-6">Usa la variable <code class="bg-slate-900 p-1 rounded text-cyan-400">{{name}}</code> en los mensajes para personalizarlos with el nombre del cliente.</p>
                <div class="space-y-8">
